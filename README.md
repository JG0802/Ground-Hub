# ⚽️ ONLINE LOCKER-ROOM Flatform ⚽️

Maven 기반의 **Spring Boot 백엔드**와 **HTML/CSS/JavaScript 프론트엔드**로 구성된 웹 애플리케이션입니다.  
이 프로젝트는 **NCP 서버에 배포하여 실제 운영 환경에서 실행**할 예정이며, 추후 외부 API를 단계적으로 추가해나갈 계획에 있습니다.
...
이 프로젝트는 2025 단국대학교 창업동아리의 출안 서비스입니다.
ONLINE LOCKER-ROOM 서비스에서 나아가,
1️⃣ 팀 SNS 프로필 서비스를 제공하여 **팀 스폰서**, **AI 기반 매칭 시스템**, **구역내 리그컵 개최**,
2️⃣ 개인 SNS 프로필 서비스 또한 제공하여 **특정 팀에 필요한 포지션의 개인 유저를 검색 및 추천**,
의 기능을 제공할 예정입니다.😊
---
